...
def calculate_npk(sample, weight):
    ...
    total_percentage = npk_values['Nitrogen (%)'] + npk_values['Phosphorus (%)'] + npk_values['Potassium (%)']
    if total_percentage > 100:
        normalization_factor = 100 / total_percentage
        npk_values['Nitrogen (%)'] *= normalization_factor
        npk_values['Phosphorus (%)'] *= normalization_factor
        npk_values['Potassium (%)'] *= normalization_factor
